const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/async-entry-C4ymvyal.js","assets/env-probe-onCPqYYW.js"])))=>i.map(i=>d[i]);
import { n as __toESM, t as __commonJSMin } from "./rolldown-runtime-FDOR9p9I.js";
import { n as serializeProbeValue, t as collectEnvProbeRows } from "./env-probe-onCPqYYW.js";
...
var routeIds = new Set(routes.map((route) => route.id));
function readRouteFromHash() {
	const route = globalThis.location?.hash.replace(/^#\/?/, "");
	return routeIds.has(route) ? route : "summary";
}
function EnvProbeApp({ runtimeName }) {
	const [route, setRoute] = (0, import_react.useState)(() => readRouteFromHash());
	const rows = (0, import_react.useMemo)(() => globalThis.__ENV_PROBE_ROWS__ ?? collectEnvProbeRows(runtimeName), [runtimeName]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Env bundler probe" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Runtime: ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: runtimeName })] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				...
				children: routes.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
				...
				] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: visibleRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						style: cellStyle,
						children: serializeProbeValue(row.value)
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
						style: cellStyle,
						children: row.note
...
//#endregion
//#region src/browser-entry.tsx
collectEnvProbeRows("vite");
__vitePreload(async () => {
	const { collectAsyncEnvProbeRows } = await import(
		/* webpackChunkName: "async-entry" */
		"./async-entry-C4ymvyal.js"
);
	return { collectAsyncEnvProbeRows };
}, __vite__mapDeps([0,1])).then(({ collectAsyncEnvProbeRows }) => {
	collectAsyncEnvProbeRows("vite");
});
(0, import_client.createRoot)(document.getElementById("root")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.StrictMode, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EnvProbeApp, { runtimeName: "vite" }) }));
//#endregion
